...
export function GameClock({ initialMs, isRunning, showMs = false, onExpire }: Props) {
    ...
    return (
        <div className={`font-mono tabular-nums text-4xl font-bold ${expired ? "text-destructive" : "text-foreground"}`}>
            {display}
        </div>
    )
}
