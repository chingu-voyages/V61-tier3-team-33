...
import { STALEMATE, THREEFOLD_REPETITION, FIFTY_MOVE_RULE, INSUFFICIENT_MATERIAL } from "./game";
import type { DrawReason } from "./game";

export const Reason = {
  endLabel(reason: EndReason): string {
    switch (reason) {
      case RULES: return "by checkmate";
      case TIMEOUT: return "on time";
      case RESIGNATION: return "by resignation";
      case ABANDONED: return "by abandonment";
      default: return "";
    }
  },
