...
export { PieceColor, PieceType, WHITE, BLACK, PAWN, KNIGHT, BISHOP, ROOK, QUEEN, KING } from "./core/piece";
export type { GameResult } from "./core/game";
export { GameStatus, IN_PROGRESS, CHECKMATE, DRAW, STALEMATE } from "./core/game";
...
export class Chess {
  ...
  status(): GameResult {
    return this.rules.getGameResult(this.ctx, this.engine, this.tracker, this.currentHash);
  }
}